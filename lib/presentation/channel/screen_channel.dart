...
class _ScreenChannelState extends State<ScreenChannel>
  ...
  /// Modern YouTube open button with pill design
  Widget _buildModernYouTubeButton(BuildContext context, String url) {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 20),
      child: Material(
        color: Colors.transparent,
        child: InkWell(
          onTap: () async => await urlLaunchWithSettings(context, url),
